...
function changeInfor(type) {
    ...
    switch (type) {
        ...
        case 2:
            ...
            title.textContent = "奇美博物館";
            title.style.left = "33%"
            title.style.width = "220px"
            break;
        case 3:
            picture.src = "https://www.taiwan.net.tw/pic.ashx?qp=1/big_scenic_spots/pic_10352_12.jpg&sizetype=3";
            intro.textContent = "是臺灣面積最大、最晚發展的七股鹽場遺蹟之一。鹽山如白雪耀眼，像長年堆雪的長白山，也稱作「南台的長白山」，而來臺觀光的日本人則戲稱是「台灣的富士山」。"
            speaker.alt = "tainan_f3"
            title.textContent = "七股鹽山";
            title.style.left = "33%"
            title.style.width = "220px"
            break;
        case 4:
