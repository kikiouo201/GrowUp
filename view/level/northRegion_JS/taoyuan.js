function changeInfor(type) {
    ...
    switch (type) {
        ...
        case 1:
            ...
            title.textContent = "大溪豆乾";
            title.style.left = "33%"
            title.style.width = "220px"
            break;
        case 2:
            picture.src = "https://attach.setn.com/newsimages/2020/06/30/2635413-XXL.jpg";
            intro.textContent = "是台灣與日本耗時5年規劃打造，是台灣第一座新都會型的水生公園，顛覆傳統水族館樣貌。"
            speaker.alt = "taoyuan_f2"
            title.textContent = "X park 水族館";
            title.style.left = "33%"
            title.style.width = "220px"
            break;
        case 3:
