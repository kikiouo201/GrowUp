function changeInfor(type) {
    ...
    switch (type) {
        ...
        case 2:
            ...
            title.textContent = "八卦山";
            title.style.left = "32%"
            title.style.width = "220px"
            break;
        case 3:
            picture.src = "https://leafyeh.com/wp-content/uploads/flickr/48250627257_98f549c20e_o.jpg";
            intro.textContent = "有著外星人的秘密基地與外星人打蛋器之稱，主要是蓄電用的風車，形狀為三葉式造型，是目前全世界唯一獲得認證的垂直軸小風力發電機。"
            speaker.alt = "changhua_f3"
            title.textContent = "王功小型風力發電區";
            title.style.left = "20%"
            title.style.width = "375px"
            break;
